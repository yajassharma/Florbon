...
export default function Checkout() {
  const { bouquet, bouquetStyle, wrapping, deliverySpeed, setDeliverySpeed, totalPrice, clearBouquet, aiPreviewApproved } = useStore();
  ...
  const wrappingTotal = wrapping?.price || 0;
  const deliveryTotal = deliverySpeed === 'express' ? 15 : 5;
  const makingCharge = bouquetStyle === 'flat_layered' ? 10 : 5;
  ...
  if (step === 'success') {
    return (
      <div className="h-full flex flex-col items-center justify-center p-6 text-center bg-emerald-50">
        <motion.div 
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-emerald-100 w-full max-w-sm mb-8">
    ...
    <div className="h-full flex flex-col bg-stone-50">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-stone-100">
              ...
              <div className="space-y-3">
                <label className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-colors ${deliverySpeed === 'standard' ? 'border-emerald-500 bg-emerald-50/50' : 'border-stone-100'}`}>
                  <div className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${deliverySpeed === 'standard' ? 'border-emerald-500' : 'border-stone-300'}`}>
                      {deliverySpeed === 'standard' && <div className="w-2.5 h-2.5 bg-emerald-500 rounded-full" />}
                    </div>
                    <div>
                  ...
                  <span className="text-sm font-medium text-stone-800">$5.00</span>
                </label>
                
                <label className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-colors ${deliverySpeed === 'express' ? 'border-emerald-500 bg-emerald-50/50' : 'border-stone-100'}`}>
                  <div className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${deliverySpeed === 'express' ? 'border-emerald-500' : 'border-stone-300'}`}>
                      {deliverySpeed === 'express' && <div className="w-2.5 h-2.5 bg-emerald-500 rounded-full" />}
                    </div>
                    <div>
                      <p className="text-sm font-medium text-stone-800">Express Delivery</p>
                      <p className="text-xs text-emerald-600 font-medium">Today within 3 hours</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-stone-800">$15.00</span>
                </label>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-stone-100 space-y-3">
              ...
              <div className="flex justify-between text-sm text-stone-500">
                <span>Wrapping</span>
                <span>${wrappingTotal.toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-sm text-stone-500">
                <span>Delivery</span>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-stone-100">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" defaultValue="Jane Doe" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-stone-500 mb-1 uppercase tracking-wider">Phone Number</label>
                  <input type="tel" defaultValue="+1 (555) 123-4567" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-stone-500 mb-1 uppercase tracking-wider">Street Address</label>
                  <input type="text" defaultValue="123 Floral Lane, Apt 4B" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-stone-500 mb-1 uppercase tracking-wider">City</label>
                    <input type="text" defaultValue="San Francisco" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-stone-500 mb-1 uppercase tracking-wider">Zip Code</label>
                    <input type="text" defaultValue="94105" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-stone-100">
              ...
              <div className="space-y-3 mb-6">
                <label className="flex items-center justify-between p-4 rounded-xl border-2 border-emerald-500 bg-emerald-50/50 cursor-pointer">
                  <div className="flex items-center gap-3">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" placeholder="0000 0000 0000 0000" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 font-mono" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-stone-500 mb-1 uppercase tracking-wider">Expiry</label>
                    <input type="text" placeholder="MM/YY" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 font-mono" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-stone-500 mb-1 uppercase tracking-wider">CVC</label>
                    <input type="text" placeholder="123" className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 font-mono" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="p-6 bg-white border-t border-stone-200">
        <button 
          ...
          className="w-full bg-emerald-600 text-white py-4 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-emerald-700 transition-colors disabled:opacity-70 shadow-lg shadow-emerald-600/20"
        >
          {isProcessing ? (
            <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
          ) : (
            <>
              {step === 'summary' ? 'Continue to Delivery' : step === 'address' ? 'Continue to Payment' : `Pay $${total.toFixed(2)}`}
